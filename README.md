...
## Leaderboard
Сводную таблицу с прогрессом кандидатов (авто- и ручные оценки) см. в [`LEADERBOARD.md`](LEADERBOARD.md). Сейчас лучше всех выступил кандидат с покрытием 86 % (52/60) и временем 15:39, но ручная проверка показала ≈45 % релевантных запросов. Остальные решения также оценены в таблице.
